...
void callback(const pouco2000_ros::Controller::ConstPtr& msg, ExtractorButton& extractor){
    bool value;
...
int main(int argc, char **argv){
  ...
  ros::Subscriber sub = n.subscribe<pouco2000_ros::Controller>("controller",1000,callback_extractor);
