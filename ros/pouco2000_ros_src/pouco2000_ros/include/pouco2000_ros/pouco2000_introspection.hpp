 ...
 */
namespace extract {
    pouco2000_ros_msgs::Buttons field_buttons(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
    pouco2000_ros_msgs::SwitchsOnOff field_switchs_onoff(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
    pouco2000_ros_msgs::SwitchsMode field_switchs_modes(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
    pouco2000_ros_msgs::Potentiometers field_potentiometers_circle(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
    pouco2000_ros_msgs::Potentiometers field_potentiometers_slider(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
};
 ...
 * @tparam T_msg_field type of field, where data is located, for example: pouco2000_ros_msgs::Buttons
 */
...
class FilterPublisher{
    ...
    private: 
        ...
        void callback(const pouco2000_ros_msgs::Controller::ConstPtr& msg, 
                      ros::Publisher& pub,
                      boost::function< T_msg_field (const pouco2000_ros_msgs::Controller::ConstPtr& msg)> extracter,
                      int position);
    public:
        /**
...
FilterPublisher<T_msg_send,T_msg_field>::FilterPublisher(ros::NodeHandle& n,
    ...
    this->sub = n.subscribe<pouco2000_ros_msgs::Controller>(topic_sub,FilterPublisher::QUEUE_SIZE_SUBSCRIBER,callback_bind);
}

template<typename T_msg_send,typename T_msg_field>
void FilterPublisher<T_msg_send,T_msg_field>::callback(const pouco2000_ros_msgs::Controller::ConstPtr& msg, 
                       ros::Publisher& pub,
                       boost::function< T_msg_field (const pouco2000_ros_msgs::Controller::ConstPtr& msg)> extracter,
                       int position){
