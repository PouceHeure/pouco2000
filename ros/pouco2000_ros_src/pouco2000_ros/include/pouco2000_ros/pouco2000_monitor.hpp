...
class Monitor: public ContainerVertical {
    private: 
        ...
        void init_buttons(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
        void update_buttons(const pouco2000_ros_msgs::Controller::ConstPtr& msg);

        void init_potentiometers_slider(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
        void update_potentiometers_slider(const pouco2000_ros_msgs::Controller::ConstPtr& msg);

        void init_switchs_modes(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
        void update_switchs_modes(const pouco2000_ros_msgs::Controller::ConstPtr& msg);

        void init_switchs_onoff(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
        void update_switchs_onoff(const pouco2000_ros_msgs::Controller::ConstPtr& msg);

        void init_potentiometers_circle(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
        void update_potentiometers_circle(const pouco2000_ros_msgs::Controller::ConstPtr& msg);
